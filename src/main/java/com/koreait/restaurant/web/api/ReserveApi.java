...
public class ReserveApi {
    ...
    public ResponseEntity<?> getCheckPage(@RequestBody DinningMst dinningMst) {
        ...
        searchService.duplicateReserveId(dinningMst.getReserveId());
        searchService.duplicateReserveNumber(dinningMst.getNumber());
        searchService.duplicateReserveName(dinningMst.getReserveName());
